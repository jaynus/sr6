import { SR6Token } from '../../../../../src/token/SR6Token';
...
declare global {
	...
	class DetectionMode {
		 ...
		 */
		protected _canDetect(visionSource: VisionSource<Token>, target: SR6Token): boolean;
	...
	class DetectionModeInvisibility extends DetectionMode {
		...
		protected override _canDetect(visionSource: VisionSource<Token>, target: SR6Token): boolean;
	}
